...
Emulator.prototype.placeOrders = function (req, res, cb) {
    ...
    if (!marketId || !instructions || instructions.length < 1) {
        self.sendErrorResponse(res, -32602, "Invalid <Place> Instructions: Missing mandatory parameters.");
        return;
    }
...
Emulator.prototype.replaceOrders = function (req, res, cb) {
    ...
    var instructions = req.params.instructions;
    if (!marketId || !instructions || instructions.length < 1) {
        self.sendErrorResponse(res, -32602, "Invalid <Replace> Instructions: Missing mandatory parameters.");
        cb(null);
        return;
    }
...
Emulator.prototype.updateOrders = function (req, res, cb) {
    ...
    var instructions = req.params.instructions;
    if (!marketId || !instructions || instructions.length < 1) {
        self.sendErrorResponse(res, -32602, "Invalid <Update> Instructions: Missing mandatory parameters.";
        cb(null);
        return;
    }
...
Emulator.prototype.cancelOrders = function (req, res, cb) {
    ...
    var instructions = req.params.instructions;
    if (!marketId || !instructions || instructions.length < 1) {
        self.sendErrorResponse(res, -32602, "Invalid <Cancel> Instructions: Missing mandatory parameters.");
        cb(null);
        return;
    }
